    ...
    <main className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <CategoryCard
          ...
          icon="⛽"
          description="C-store and fuel station POS scenarios including age verification and prepay."
          itemCount={0}
...
const ScanBookView = ({ category, onBack }) => {
  ...
  const currentTest = groceryData.tests.find(t => t.id === selectedTest);
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-slate-800">Grocery POS Test Script</h1>
        ...
        <div className="bg-blue-50 border-b border-blue-100">
          <div className="max-w-7xl mx-auto px-4 py-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
              {groceryData.loyaltyAccounts.map((account, i) => (
